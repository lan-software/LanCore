...
return [
    ...
    'apps' => [
        ...
        'lanbrackets' => [
            ...
            'callback_path' => env('LANBRACKETS_CALLBACK_PATH', '/auth/lancore/callback'),
            'scopes' => ['user:read', 'user:email', 'user:roles'],
            'nav_url' => env('LANBRACKETS_NAV_URL'),
            'nav_icon' => 'trophy',
            'nav_label' => 'Brackets',
            'send_announcements' => env('LANBRACKETS_SEND_ANNOUNCEMENTS', false),
            'announcement_path' => env('LANBRACKETS_ANNOUNCEMENT_PATH', '/api/webhooks/announcements'),
            'send_role_updates' => env('LANBRACKETS_SEND_ROLE_UPDATES', true),
            'roles_path' => env('LANBRACKETS_ROLES_PATH', '/api/webhooks/roles'),
        ...
        'lanentrance' => [
            ...
            'callback_path' => env('LANENTRANCE_CALLBACK_PATH', '/auth/lancore/callback'),
            'scopes' => ['user:read', 'user:email', 'user:roles'],
            'nav_url' => env('LANENTRANCE_NAV_URL'),
            'nav_icon' => 'door-open',
            'nav_label' => 'Entrance',
            'send_announcements' => env('LANENTRANCE_SEND_ANNOUNCEMENTS', false),
            'announcement_path' => env('LANENTRANCE_ANNOUNCEMENT_PATH', '/api/webhooks/announcements'),
            'send_role_updates' => env('LANENTRANCE_SEND_ROLE_UPDATES', true),
            'roles_path' => env('LANENTRANCE_ROLES_PATH', '/api/webhooks/roles'),
        ...
        'lanshout' => [
            ...
            'callback_path' => env('LANSHOUT_CALLBACK_PATH', '/auth/lancore/callback'),
            'scopes' => ['user:read', 'user:email', 'user:roles'],
            'nav_url' => env('LANSHOUT_NAV_URL'),
            'nav_icon' => 'megaphone',
            'nav_label' => 'Shout',
            'send_announcements' => env('LANSHOUT_SEND_ANNOUNCEMENTS', true),
            'announcement_path' => env('LANSHOUT_ANNOUNCEMENT_PATH', '/api/webhooks/announcements'),
            'send_role_updates' => env('LANSHOUT_SEND_ROLE_UPDATES', true),
            'roles_path' => env('LANSHOUT_ROLES_PATH', '/api/webhooks/roles'),
        ...
        'lanhelp' => [
            ...
            'callback_path' => env('LANHELP_CALLBACK_PATH', '/auth/lancore/callback'),
            'scopes' => ['user:read', 'user:email', 'user:roles'],
            'nav_url' => env('LANHELP_NAV_URL'),
            'nav_icon' => 'life-buoy',
            'nav_label' => 'Help',
            'send_announcements' => env('LANHELP_SEND_ANNOUNCEMENTS', true),
            'announcement_path' => env('LANHELP_ANNOUNCEMENT_PATH', '/api/webhooks/announcements'),
            'send_role_updates' => env('LANHELP_SEND_ROLE_UPDATES', true),
            'roles_path' => env('LANHELP_ROLES_PATH', '/api/webhooks/roles'),
