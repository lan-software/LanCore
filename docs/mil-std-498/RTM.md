...
| SET-F-011 | Per-block ticket-category allowlist | `Domain/Seating/Support/SeatingCategoryRules.php`, `Domain/Ticketing/Policies/TicketPolicy.php` (unchanged; enforcement lives in action), `Domain/Seating/Actions/AssignSeat.php::ensureBlockAcceptsCategory`, `Domain/Seating/Http/Requests/UpdateSeatPlanRequest.php`, `resources/js/pages/seating/Picker.vue`, `resources/js/pages/seating/partials/BlockCategoryEditor.vue`, `resources/js/types/domain.ts` | `Unit/Domain/Seating/SeatingCategoryRulesTest.php` (5 tests), `Feature/Seating/CategoryRestrictionPickerTest.php` (3 tests — SEAT-012/013/014) | Covered |
| SET-F-012 | Two-phase update with invalidation guard | `Domain/Seating/Actions/UpdateSeatPlan.php`, `Domain/Seating/Support/UpdateSeatPlanResult.php`, `Domain/Seating/Http/Controllers/SeatPlanController.php::update`, `Domain/Seating/Http/Requests/UpdateSeatPlanRequest.php` | `Unit/Domain/Seating/UpdateSeatPlanTest.php` (4 tests — SEAT-015/016), `Feature/Seating/SeatPlanInvalidationFlowTest.php` | Covered |
| SET-F-013 | Transactional release + SeatAssignmentInvalidated event | `Domain/Seating/Actions/UpdateSeatPlan.php`, `Domain/Seating/Events/SeatAssignmentInvalidated.php`, `Domain/Seating/Listeners/NotifyAffectedAssignees.php`, `app/Providers/AppServiceProvider.php` (listener wiring) | `Unit/Domain/Seating/UpdateSeatPlanTest.php` (dispatch assertion — SEAT-017), `Feature/Seating/SeatPlanInvalidationFlowTest.php` | Covered |
| SET-F-014 | Notification channels + preferences | `Domain/Notification/Notifications/SeatAssignmentInvalidatedNotification.php`, `Domain/Notification/Models/NotificationPreference.php`, migration `2026_04_23_185519_add_seating_flags_to_notification_preferences_table.php` | `Unit/Domain/Notification/SeatAssignmentInvalidatedNotificationTest.php` (4 tests — SEAT-018 via() branches), `Feature/Seating/SeatPlanInvalidationFlowTest.php` (end-to-end dispatch) | Covered |
