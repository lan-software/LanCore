...
const isLoading = ['pending', 'selecting_server', 'deploying'].includes(
    props.job.status,
);
...
<template>
    <div class="rounded-lg border p-4">
        ...
        <div
            v-if="job.status === 'active' && job.game_server"
        ...
        >
            ...
            <div
                v-if="job.game_server.credentials?.server_password"
            ...
            >
                ...
                <code class="rounded bg-muted px-2 py-1 font-mono text-sm">
                    {{
                        showPassword
                            ? job.game_server.credentials.server_password
                            : '********'
                    }}
                </code>
                <Button
