...
import { update, destroy } from '@/actions/App/Domain/Achievements/Http/Controllers/AchievementController'
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: achievementEdit({ achievement: props.achievement.id }).url },
]
        ...
        <div class="flex h-full flex-1 flex-col gap-8 p-4 max-w-3xl">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <Badge v-if="achievement.is_active" variant="default">Active</Badge>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div class="space-y-4">
                    <Heading variant="small" title="Achievement Information" description="Update the achievement badge details" />
                ...
                <div class="flex items-center justify-between">
                    ...
                    <Button variant="destructive" type="button" @click="deleteAchievement">
                        Delete Achievement
                    </Button>
                </div>
            </form>

            <div v-if="achievement.users_count" class="text-sm text-muted-foreground">
                This achievement has been earned by {{ achievement.users_count }} user(s).
            </div>
        </div>
    </AppLayout>
</template>
