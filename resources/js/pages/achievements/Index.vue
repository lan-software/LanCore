...
const { setSearch, toggleSort, setFilter, setPage, setPerPage } = useDataTable(
    () => achievementsRoute().url,
    props.filters,
);
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            <Table class="border">
                ...
                <TableBody>
                    <TableRow
                        ...
                        @click="
                            router.visit(
                                edit({ achievement: row.original.id }).url,
                            )
                        "
                    >
                        <TableCell
            ...
            <div class="flex items-center justify-between border-t pt-4">
                ...
                >
                    ...
                    <Select
                        :model-value="String(achievements.per_page)"
                        @update:model-value="
                    ...
                    <span v-if="achievements.from && achievements.to">
                        {{ achievements.from }}–{{ achievements.to }} of
                        {{ achievements.total }}
                    </span>
                </div>
