                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <span v-if="team.tag" class="text-xs text-muted-foreground">[{{ team.tag }}]</span>
                        </div>
                        <Badge v-if="team.is_captain" variant="outline" class="text-[10px]">
                    ...
                    <div class="mt-auto flex items-center gap-3 pt-3 text-xs text-muted-foreground">
                        <span class="flex items-center gap-1">
                            <Users class="size-3" />
                            {{ team.active_members_count }}<template v-if="team.competition?.team_size"> / {{ team.competition.team_size }}</template>
                        </span>
                    </div>
                </Link>
            </div>
