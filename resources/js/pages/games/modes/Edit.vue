...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: props.gameMode.name,
        href: GameModeController.edit({
            game: props.game.id,
            mode: props.gameMode.id,
        }).url,
    },
];
...
const parametersJson = props.gameMode.parameters
    ? JSON.stringify(props.gameMode.parameters, null, 2)
    : '';
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full max-w-2xl flex-1 flex-col gap-8 p-4">
            ...
            <Form
                v-bind="
                    GameModeController.update.form({
                        game: game.id,
                        mode: gameMode.id,
                    })
                "
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            min="1"
                            max="1440"
                            :default-value="gameMode.match_length_minutes ?? ''"
                            :placeholder="
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Permanently delete this game mode.
                        </p>
                    </div>
                    <Button
                        variant="destructive"
        ...
        <Dialog v-model:open="showDeleteDialog">
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        This action cannot be undone. This game mode will be
                        permanently removed.
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter>
