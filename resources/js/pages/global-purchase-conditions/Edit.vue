...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit',
        href: GlobalPurchaseConditionController.edit(props.condition.id).url,
    },
];
...
function deleteCondition() {
    if (confirm('Are you sure you want to delete this condition?')) {
        router.delete(
            GlobalPurchaseConditionController.destroy(props.condition.id).url,
        );
    }
}
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full max-w-2xl flex-1 flex-col gap-8 p-4">
            ...
            <Form
                v-bind="
                    GlobalPurchaseConditionController.update.form(condition.id)
                "
                class="space-y-8"
            ...
            >
                <div class="space-y-4">
                    <Heading
                        ...
                        description="Edit the global purchase condition"
                    />
