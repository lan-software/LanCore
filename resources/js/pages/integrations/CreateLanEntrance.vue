...
import { createLanEntrance } from '@/actions/App/Domain/Integration/Http/Controllers/IntegrationAppController';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add LanEntrance', href: createLanEntrance().url },
];
</script>

<template>
    <Head title="Add LanEntrance Integration" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full max-w-2xl flex-1 flex-col gap-8 p-4">
            ...
            >
                <input type="hidden" name="name" value="LanEntrance" />
                <input type="hidden" name="slug" value="lanentrance" />
                <input
                    type="hidden"
                    name="description"
                    value="Entrance and check-in management system"
                />
                <input type="hidden" name="nav_label" value="Entrance" />
                <input type="hidden" name="nav_icon" value="door-open" />
                <input
                    type="hidden"
                    name="allowed_scopes[]"
                    value="user:read"
                ...
                <div class="space-y-4">
                    <Heading
                        variant="small"
                        title="Add LanEntrance Integration"
                        description="This will create a preconfigured integration for LanEntrance with the recommended settings."
                    />
                    ...
                    >
                        ...
                        <dl class="space-y-2 text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <dd class="font-medium">LanEntrance</dd>
                            </div>
                            <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <dd class="font-medium">Entrance</dd>
                            </div>
                ...
                <div class="space-y-4">
                    <Heading
                        ...
                        description="Provide the URLs for your LanEntrance instance"
                    />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            name="callback_url"
                            type="url"
                            value="http://localhost:84/auth/callback"
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            name="roles_endpoint"
                            type="url"
                            value="http://localhost:84/api/webhooks/roles"
                ...
                <div class="flex items-center gap-4">
                    <Button type="submit" :disabled="processing">
                        {{
                            processing
                                ? 'Creating...'
                                : 'Create LanEntrance Integration'
                        }}
                    </Button>
                </div>
            </Form>
