...
import { createLanShout } from '@/actions/App/Domain/Integration/Http/Controllers/IntegrationAppController';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add LanShout', href: createLanShout().url },
];
</script>

<template>
    <Head title="Add LanShout Integration" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full max-w-2xl flex-1 flex-col gap-8 p-4">
            ...
            >
                ...
                <input type="hidden" name="name" value="LanShout" />
                <input type="hidden" name="slug" value="lanshout" />
                <input
                    type="hidden"
                    name="description"
                    value="Real-time chat and communication platform"
                />
                <input type="hidden" name="nav_label" value="Shout" />
                <input type="hidden" name="nav_icon" value="megaphone" />
                <input
                    type="hidden"
                    name="allowed_scopes[]"
                    value="user:read"
                ...
                <div class="space-y-4">
                    <Heading
                        variant="small"
                        title="Add LanShout Integration"
                        description="This will create a preconfigured integration for LanShout with the recommended settings."
                    />
                    ...
                    >
                        ...
                        <dl class="space-y-2 text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <dd class="font-medium">LanShout</dd>
                            </div>
                            <div class="flex items-center gap-2">
                ...
                <div class="space-y-4">
                    <Heading
                        ...
                        description="Provide the URLs for your LanShout instance"
                    />
