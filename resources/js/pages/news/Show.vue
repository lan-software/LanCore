...
const ogTitle = computed(
    () =>
        props.article.og_title ||
        props.article.meta_title ||
        props.article.title,
);
const ogDescription = computed(
    () =>
        props.article.og_description ||
        props.article.meta_description ||
        props.article.summary ||
        '',
);
const ogImage = computed(
    () => props.article.og_image_url || props.article.image_url || '',
);
const metaTitle = computed(
    () => props.article.meta_title || props.article.title,
);
const metaDescription = computed(
    () => props.article.meta_description || props.article.summary || '',
);
</script>
    ...
    <div class="flex min-h-screen flex-col bg-background text-foreground">
        ...
        <main class="flex-1">
            <article class="mx-auto max-w-4xl px-6 py-12">
                ...
                <Link
                    href="/"
                    class="mb-8 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground"
                >
                ...
                <p
                    ...
                    class="mb-8 border-l-4 border-primary pl-4 text-lg text-muted-foreground italic"
                >
                    {{ article.summary }}
                </p>
        ...
        <footer class="border-t py-6">
            <div
                class="mx-auto max-w-4xl px-6 text-center text-sm text-muted-foreground"
            >
