...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full max-w-2xl flex-1 flex-col gap-8 p-4">
            ...
            <Form
                v-bind="PurchaseRequirementController.store.form()"
                class="space-y-8"
            ...
            >
                <div class="space-y-4">
                    <Heading
                        ...
                        description="Define the purchase requirement"
                    />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            name="name"
                            required
                            placeholder="e.g. Tournament Rules Agreement"
                        />
                ...
                <div class="space-y-4">
                    <Heading
                        ...
                        description="Checkboxes the buyer must accept before purchase"
                    />
