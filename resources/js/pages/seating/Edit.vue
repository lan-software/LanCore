...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.seatPlan.name, href: SeatPlanController.edit(props.seatPlan.id).url },
]
        ...
        <div class="flex h-full flex-1 flex-col gap-8 p-4 max-w-2xl">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            disabled
                        />
                        <p class="text-xs text-muted-foreground">The event cannot be changed after creation.</p>
                    </div>
            ...
            <div class="border-t pt-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-sm font-medium text-destructive">Delete Seat Plan</h3>
                        <p class="text-sm text-muted-foreground">Permanently delete this seat plan and all its data.</p>
                    </div>
                    <Button
                        variant="destructive"
                        size="sm"
        ...
        <Dialog v-model:open="showDeleteDialog">
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        This action cannot be undone. The seat plan and all its data will be permanently removed.
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter>
                    <Button
