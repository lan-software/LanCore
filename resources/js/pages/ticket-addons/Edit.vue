...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: props.ticketAddon.name,
        href: AddonController.edit(props.ticketAddon.id).url,
    },
];
            ...
            >
                <div class="space-y-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            id="name"
                            name="name"
                            :default-value="ticketAddon.name"
                            required
                    ...
                    <div class="grid gap-2">
                        ...
                        <Textarea
                            id="description"
                            name="description"
                            :default-value="ticketAddon.description ?? ''"
                            rows="3"
                ...
                <div class="space-y-4">
                    <Heading
                        ...
                        description="Update price and quota"
                    />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="number"
                                min="0"
                                :default-value="String(ticketAddon.price)"
                                required
                            />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                min="0"
                                :default-value="
                                    ticketAddon.quota !== null
                                        ? String(ticketAddon.quota)
                                        : ''
                                "
                ...
                <div class="space-y-4">
                    <Heading
                        variant="small"
                        title="Configuration"
                        description="Update addon behavior"
                    />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            type="number"
                            min="0"
                            :default-value="String(ticketAddon.seats_consumed)"
                        />
                    ...
                    <div class="flex items-center gap-2">
                        <Checkbox
                            ...
                            :default-value="ticketAddon.requires_ticket"
                        />
                        <Label for="requires_ticket" class="cursor-pointer"
                            >Requires a ticket</Label
                        >
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <Checkbox
                            id="is_hidden"
                            name="is_hidden"
                            :default-value="ticketAddon.is_hidden"
                        />
                        <Label for="is_hidden" class="cursor-pointer"
                            >Hidden from shop</Label
                        >
                    </div>
                ...
                <div class="space-y-4">
                    <Heading
                        variant="small"
                        title="Association"
                        description="Link this addon to an event"
                    />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select
                            name="event_id"
                            :default-value="String(ticketAddon.event_id)"
                        >
                            <SelectTrigger>
