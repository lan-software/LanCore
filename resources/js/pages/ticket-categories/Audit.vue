...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: props.ticketCategory.name,
        href: TicketCategoryController.edit(props.ticketCategory.id).url,
    },
...
<template>
    <Head :title="`Audit Log – ${ticketCategory.name}`" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold">
                    Audit Log for {{ ticketCategory.name }}
                </h2>
                <Button variant="outline" as-child>
                    <Link
                        :href="
                            TicketCategoryController.edit(ticketCategory.id).url
                        "
                        >Back to Ticket Category</Link
                    >
                </Button>
            </div>
                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        <TableEmpty v-else :colspan="4"
                            >No audit entries found.</TableEmpty
                        >
                    </TableBody>
                </Table>
