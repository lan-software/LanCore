...
function executeDelete() {
    router.delete(
        TicketCategoryController.destroy(props.ticketCategory.id).url,
        {
            onSuccess: () => {
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select
                            name="event_id"
                            :default-value="
                                ticketCategory.event_id
                                    ? String(ticketCategory.event_id)
                                    : undefined
                            "
                        >
                            <SelectTrigger>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Permanently delete this ticket category.
                        </p>
                    </div>
                    <Button
                        variant="destructive"
        ...
        <Dialog v-model:open="showDeleteDialog">
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        This action cannot be undone. The ticket category will
