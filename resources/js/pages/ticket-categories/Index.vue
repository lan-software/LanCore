            ...
            >
                ...
                >
                    <span class="text-xs text-muted-foreground">
                        <template
                            v-if="ticketCategories.from && ticketCategories.to"
                        >
                            Showing {{ ticketCategories.from }}–{{
                                ticketCategories.to
                            }}
                            of {{ ticketCategories.total }} ticket categories
                        </template>
                        <template v-else>
