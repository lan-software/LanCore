...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-8 p-4 max-w-2xl">
            ...
            <Form v-bind="VoucherController.store.form()" class="space-y-8" v-slot="{ errors, processing }">
                <div class="space-y-4">
                    <Heading variant="small" title="Voucher Information" description="Basic details for this voucher" />

                    <div class="grid gap-2">
                        <Label for="code">Code</Label>
                        <Input id="code" name="code" required placeholder="SUMMER2026" class="font-mono" />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-2">
                            ...
                            <Input id="discount_amount" name="discount_amount" type="number" min="0" placeholder="e.g. 500 for 5.00 €" />
                            <InputError :message="errors.discount_amount" />
                        </div>
                        <div class="grid gap-2">
                            <Label for="discount_percent">Discount Percent</Label>
                            <Input id="discount_percent" name="discount_percent" type="number" min="0" max="100" placeholder="e.g. 10" />
                ...
                <div class="space-y-4">
                    <Heading variant="small" title="Usage Limits" description="Set usage and validity constraints" />

                    <div class="grid gap-2">
                        <Label for="max_uses">Max Uses</Label>
                        <Input id="max_uses" name="max_uses" type="number" min="1" placeholder="Leave empty for unlimited" />
