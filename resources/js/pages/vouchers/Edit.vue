...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: props.voucher.code,
        href: VoucherController.edit(props.voucher.id).url,
    },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
            ...
            >
                    ...
                    <div class="grid grid-cols-2 gap-4">
                            ...
                            <Input
                                ...
                                :default-value="
                                    voucher.discount_amount !== null
                                        ? String(voucher.discount_amount)
                                        : ''
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                max="100"
                                :default-value="
                                    voucher.discount_percent !== null
                                        ? String(voucher.discount_percent)
                                        : ''
                                "
                            />
                ...
                <div class="space-y-4">
                    <Heading
                        variant="small"
                        title="Usage Limits"
                        description="Update usage and validity constraints"
                    />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="datetime-local"
                                :default-value="
                                    formatDateTimeLocal(voucher.valid_from)
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="datetime-local"
                                :default-value="
                                    formatDateTimeLocal(voucher.valid_until)
                                "
                            />
                    ...
                    <div class="flex items-center gap-2">
                        <Checkbox
                            id="is_active"
                            name="is_active"
                            :default-value="voucher.is_active"
                        />
        ...
        <Dialog v-model:open="showDeleteDialog">
            <DialogContent>
                <DialogHeader>
                    <DialogTitle
                        >Delete voucher "{{ voucher.code }}"?</DialogTitle
                    >
                    <DialogDescription
