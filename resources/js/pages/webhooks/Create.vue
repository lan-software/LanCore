    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-8 p-4 max-w-3xl">
            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div class="space-y-4">
                    <Heading variant="small" title="Webhook Details" description="Configure an outgoing webhook endpoint" />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="secret" v-model="form.secret" placeholder="Used to sign webhook payloads (HMAC-SHA256)" />
