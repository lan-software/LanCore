...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .notes { margin-top: 30px; padding: 12px; background: #f9f9f9; border-radius: 4px; font-size: 10px; color: #555; }
    ...
    <table style="width:100%; margin-bottom: 30px;">
        <tr>
            <td style="vertical-align: top;">
                ...
                @if($org['website'])<div class="org-detail">{{ $org['website'] }}</div>@endif
            </td>
            ...
            <tr>
                ...
                <td style="text-align: right;">
                    <table class="meta-table" style="margin-left: auto; width: 250px;">
                        <tr><td class="label">Invoice Date</td><td style="text-align: right;">{{ $order->created_at->format('d M Y') }}</td></tr>
                        <tr><td class="label">Invoice Time</td><td style="text-align: right;">{{ $order->created_at->format('H:i') }}</td></tr>
