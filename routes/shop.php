...
// User-facing cart + checkout flows (stays at root — part of the public shop journey)
...
Route::middleware(['auth', 'verified'])->prefix('portal')->group(function () {
    Route::get('orders', [UserOrderController::class, 'index'])->name('my-orders.index');
    Route::get('orders/{order}', [UserOrderController::class, 'show'])->name('my-orders.show');
});

// Admin: shop CRUD + admin orders
