...
it('allows admins to view purchase requirements index', function () {
    ...
    $this->actingAs($admin)
        ->get('/backstage/purchase-requirements')
        ->assertSuccessful()
        ->assertInertia(
            fn ($page) => $page
...
it('allows admins to view create page', function () {
    ...
    $this->actingAs($admin)
        ->get('/backstage/purchase-requirements/create')
        ->assertSuccessful()
        ->assertInertia(
            fn ($page) => $page
...
it('allows admins to store a purchase requirement', function () {
    ...
    $this->actingAs($admin)
        ->post('/backstage/purchase-requirements', [
        ...
        ->assertRedirect('/backstage/purchase-requirements');
...
it('allows admins to update a purchase requirement', function () {
    ...
    $this->actingAs($admin)
        ->patch("/backstage/purchase-requirements/{$requirement->id}", [
...
it('allows admins to delete a purchase requirement', function () {
    ...
    $this->actingAs($admin)
        ->delete("/backstage/purchase-requirements/{$requirement->id}")
        ->assertRedirect('/backstage/purchase-requirements');
